(function () {
  ...
  const i18n = {
    zh: {
      ...
      walkTitle: "实地走一遍：布里恩茨湖 → 吉斯巴赫瀑布",
      walkP1: "用最受欢迎的布里恩茨湖路线举例，具体说说工具生成的行程长什么样。",
      walkP2: "从布里恩茨码头出发，先坐15分钟渡轮到吉斯巴赫——这段航程本身就是重头戏，湖水在阳光下常常呈现出一种近乎不真实的绿松石色，两岸是陡峭的山坡和散落的木屋。",
    ...
    en: {
      ...
      walkTitle: "Walking through it: Lake Brienz → Giessbach Falls",
      walkP1: "Using the most popular Lake Brienz route as an example, here's what the tool's generated itinerary actually looks like in practice.",
      walkP2: "You start at the Brienz pier with a 15-minute boat crossing to Giessbach — the crossing itself is a highlight, with the lake often turning an almost unreal turquoise in the sun, framed by steep hillsides and scattered wooden chalets.",
    ...
    de: {
      ...
      walkTitle: "Einmal durchgespielt: Brienzersee → Giessbachfälle",
      walkP1: "Am Beispiel der beliebtesten Brienzersee-Route zeigen wir konkret, wie das vom Tool erstellte Programm tatsächlich aussieht.",
      walkP2: "Los geht's am Steg in Brienz mit einer 15-minütigen Schifffahrt nach Giessbach — die Überfahrt selbst ist schon ein Highlight, der See schimmert in der Sonne oft in einem fast unwirklichen Türkis, umrahmt von steilen Hängen und verstreuten Holzhäusern.",
  ...
  // A hung public API (seen live on transport.opendata.ch) would otherwise leave
  // planRoute() stuck forever on a fetch that never resolves or rejects.
